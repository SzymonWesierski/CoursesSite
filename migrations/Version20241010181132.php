 ...
 */
final class Version20241010181132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course ADD COLUMN rating_average DOUBLE PRECISION NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__course AS SELECT id, user_id, name, description, image_path, status, public_image_id, price FROM course');
        ...
        $this->addSql('INSERT INTO course (id, user_id, name, description, image_path, status, public_image_id, price) SELECT id, user_id, name, description, image_path, status, public_image_id, price FROM __temp__course');
