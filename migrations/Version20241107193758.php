 ...
 */
final class Version20241107193758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN public_image_id VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN image_path VARCHAR(255) DEFAULT NULL');
    }
